...
export default function NavBar(){
    ...
    return (
        <div className={`${navbar ? 'fixed z-50 bg-white w-full' : null} flex justify-between items-center px-8 py-3 md:px-16 lg:px-36`}>
            ...
            {/* MOBILE  */}
            {navbar ? 
            <div className="fixed md:hidden inset-0  z-50 w-full h-full py-10 text-center left-0 top-20 bg-white border-t-2">
                <div className="mb-16">
                    <ul className="flex flex-col space-y-3 uppercase">
                        <li className="text-medium-blue-color"><Link href={""}>Home</Link></li>
                        <li><Link href={""}>About Us</Link></li>
                        <li><Link href={""}>Services</Link></li>
                        <li><Link href={""}>Projects</Link></li>
